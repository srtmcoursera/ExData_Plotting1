## Script for creating and saving to a file in PNG format a histogram
## of "Global Active Power (kilowatts)" information using data from the
## dates 2007-02-01 and 2007-02-02 of the “Individual household
## electric power consumption Data Set”, available from the UC Irvine
## Machine Learning Repository. This is part of Week 1 project of the
## "Exploratory Data Analysis" course from Coursera's Data Science
## Specialization.
##
...
## Creates and saves to a file in PNG format a histogram of "Global
## Active Power (kilowatts)" information using data from the dates
## 2007-02-01 and 2007-02-02 of the “Individual household electric
